    ...
    <div className="home-container">
      ...
      <div className="home-header">
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          <span className="Heading home-logo">PIXELPENGUINS</span>
        ...
        <div className="home-features-container">
          <div id="Features" className="home-features1">
            ...
            <div className="home-container04">
              ...
              ></FeatureCard>
              <FeatureCard
                Heading="Community-driven Marketplace"
      ...
      <div className="home-pricing">
        <div className="home-pricing1">
          <div className="home-container05">
            <span className="home-text03 Content sectionTitle">
              <span>Pricing</span>
              <br></br>
            </span>
          ...
          <div className="home-container06">
            <div className="home-pricing-card">
              ...
              <div className="home-container08">
                <span className="home-free-plan-price">0.1 Sol =</span>
              </div>
              <div className="home-container09">
                ...
                <div className="home-container11">
                  ...
                  <span className="home-free-plan-features1">
                    Ability to buy and sell NFTs on the Pixel Penguins
                    marketplace
                  </span>
                </div>
      ...
      <div className="home-banner">
        <div className="home-banner1">
          <h1 className="home-banner-heading heading2 Heading">
            Welcome to Pixel Penguins
          </h1>
          <span className="home-banner-sub-heading">
            Explore and Collect Unique Pixelated NFTs on Solana Blockchain
          </span>
        ...
        <div className="home-faq-container">
          <div className="home-faq1">
            <div className="home-container14">
              <span className="home-text11 sectionTitle">
                <span>FAQ</span>
                <br></br>
              </span>
      ...
      <div className="home-footer">
        <footer className="home-footer1">
          <div className="home-container16">
            <span className="home-logo2">PIXELPENGUINS</span>
